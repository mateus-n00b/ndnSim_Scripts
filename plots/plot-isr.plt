...
#urban_pdr.dat
#urban_pdr.dat
plot "urbanisr.dat" using 1:2:3:4  title "Naive Multicast" with linespoints ls 1,\
"urbanisr.dat" using 1:2:3:4 notitle with yerrorbars ls 1,\
1 / 0 notitle  smooth csplines with lines ls 1,\
\
"urbanisr.dat" using 1:5:6:7 title "Naive Best-Route" with linespoints ls 2,\
"urbanisr.dat" using 1:5:6:7 notitle w yerrorbars ls 2,\
2 / 0 notitle  smooth csplines with lines ls 2,\
\
"urbanisr.dat" using 1:8:9:10 title "LSIF" with linespoints ls 3,\
"urbanisr.dat" using 1:8:9:10 notitle w yerrorbars ls 3,\
